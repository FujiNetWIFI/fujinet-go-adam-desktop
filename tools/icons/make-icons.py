#!/usr/bin/env python3
"""Render the desktop icon set from the shared FujiNet Go Adam launcher art.

The artwork is the Android app's adaptive icon: a transparent foreground
(data/icons/src/fujinet-go-adam-foreground.png, straight from
fujinet-go-adam/app/src/main/res/mipmap-xxxhdpi/ic_launcher_foreground.png)
...
def main() -> int:
    ...
    for size in SIZES:
        out = OUTDIR / f"{size}x{size}" / "apps" / "fujinet-go-adam.png"
