/*
 * Symbol tables for the adamdebug engine. Parses the ".sym" format
 * ("HHHH NAME [; comment]" per line) from files or the built-in EOS/OS7
 * tables generated by tools/symbols/extract-symbols.py.
 *
