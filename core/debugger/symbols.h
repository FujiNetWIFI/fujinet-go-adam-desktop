/*
 * Symbol tables (internal to the adamdebug engine).
 * SPDX-License-Identifier: GPL-3.0-or-later
 */

#ifndef ADAMDEBUG_SYMBOLS_H
#define ADAMDEBUG_SYMBOLS_H
...
extern const char adamdebug_builtin_eos_sym[];
extern const char adamdebug_builtin_os7_sym[];

#endif /* ADAMDEBUG_SYMBOLS_H */
